...
class InspectionReviewController(
    ...
    fun edit(
        ...
        ApiResponse.ok(InspectionRecordResponse(service.edit(recordId, request.toMappedRecord())))
    ...
    fun confirm(
        ...
        ApiResponse.ok(InspectionRecordResponse(service.confirm(recordId, request?.memo)))
    ...
    fun reject(
        ...
        ApiResponse.ok(InspectionRecordResponse(service.reject(recordId, request?.memo)))
